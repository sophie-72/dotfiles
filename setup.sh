...
paru -S --needed curl zsh vim neovim nodejs npm papirus-icon-theme sddm hyprland waybar rofi-wayland rofi-power-menu dunst kitty qt5-base qt5-graphicaleffects qt5-quick3d qt5-quickcontrols qt5-quickcontrols2
